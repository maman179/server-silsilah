...
<div class="container-fluid pt-3">
             <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">DATA ANAK AMINAH - <?= $total_anak_aminah ?> ANAK</h3>
              </div>

<div class="container pt-2">
      <div class="row">
        <div class="col-9">
           <button type="button" class="btn btn-outline-info btn-sm"> <a href = "<?php echo base_url('cucu/print_anak_aminah'); ?>"><i class="fa fa-print"></i>PRINT</a></button>
           <button type="button" class="btn btn-outline-info btn-sm"> <a href = "#"><i class="fa fa-file"></i>EXPORT PDF</a></button>
          </div>
      </div>
</div>
