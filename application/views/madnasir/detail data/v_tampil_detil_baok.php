	...
	<nav aria-label="breadcrumb">
  	<ol class="breadcrumb">
        <li class="breadcrumb-item active">Detail Data Keluarga</li></a>
		        <li class="breadcrumb-item active" aria-current="page"><a href="<?php echo base_url('dashboard/tampil_data'); ?>">Data Orang Tua</a></li>
        <li class="breadcrumb-item active" aria-current="page">Data Cicit</li>
   </ol>
  </div>
    <div class="card-body">
...
<tbody>
		...
		<tr>
			...
			<td class="text-center"><a href="<?= site_url('dashboard/view_profile_baok/' . $u->id_baok) ?>" class="btn btn-outline-info btn-sm">View Profile</a></td>
