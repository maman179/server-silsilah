...
<div class="container-fluid pt-3">
    <div class="card card-primary">
        <div class="card-header">
          <h3 class="card-title">DATA CUCU HJ. EMAY </h3>
</div>

<div class="container pt-2">
      <div class="row">
        <div class="col-9">
           <button type="button" class="btn btn-outline-info btn-sm"> <a href = "<?php echo base_url('cicit/print_cucu_emay'); ?>"><i class="fa fa-print"></i>PRINT</a></button>
