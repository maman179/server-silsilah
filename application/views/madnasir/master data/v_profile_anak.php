	...
	<li class="breadcrumb-item active" aria-current="page">Profile Anak Madnasir</a></li>
  </ol>
  <?php 
   $no = 1;
  ...
  <div class="row gutters-sm">
     <div class="col-md-4 mb-3">
                ...
                <div class="d-flex flex-column align-items-center text-center">
                  ...
                  <img width="150px" class="img-thumbnail" src="<?php echo base_url().'/assets/foto_anak/'.$u->foto_anak;?>" onclick="myFunction(this);">
                  
                    <div class="mt-4">
                      <h4><b><?= $u->nama;?></b></h4>                     
                      <h6><?= $u->alamat;?></h6>
                      <button type="button" class="btn btn-outline-success"><a href="<?= site_url('dashboard/edit/'. $u->id_anak) ?>"></i>Update</button></a>    
                      <button type="button" class="btn btn-outline-danger" data-toggle="modal" id="BtnHapus" name="BtnUpdate" data-target="#ModalHapus<?php echo $u->id_anak;?>">Hapus</button></td>              
                      <button type="button" class="btn btn-outline-secondary"><a href="<?php echo base_url('dashboard/tampil_data_ortu'); ?>">Kembali</a></button>
                      </div>
                  </div>
                </div>
              </div>  
              ...
              <div class="card-header">
                ...
                <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-7 text-secondary">
                    <a href="<?= site_url('dashboard/detil_anak/' . $u->id_anak) ?>"><?= $u->total_anak;?> ORANG</a>       
                 </div>
                  </div>
                  <hr>
...
<div class="modal fade" id="ModalHapus<?php echo $u->id_anak;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <h5 class="list-group-item active" id="exampleModalLabel" aria-current="true">Konfirmasi Hapus</h5>
      ...
      <a href="<?= site_url('dashboard/hapus/' . $u->id_anak) ?>" class="btn btn-danger" id="btdelete">Lanjutkan</a>
      </div>
