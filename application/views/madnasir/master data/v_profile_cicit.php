...
function myFunction(imgs) 
{
  ...
  expandImg.parentElement.style.display = "block";
                    ...
                    <div class="mt-4">
                      ...
                      <button type="button" class="btn btn-outline-success"><a href="<?= site_url('dashboard/edit_cicit/'. $u->id_cicit) ?>"></i>Update</button></a>    
              ...
              <div class="card-header">
                ...
                <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-7 text-secondary">
                    <a href="<?= site_url('dashboard/tampil_detail_baok/'. $u->id_cicit) ?>"><?= $u->total_anak_cicit;?> ORANG</a>       
                 </div>
                  </div>
                  <hr>
...
<div class="modal fade" id="ModalHapus<?php echo $u->id_cicit;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <h5 class="list-group-item active" id="exampleModalLabel" aria-current="true">Konfirmasi Hapus</h5>
      ...
      <span><h4>Anda ingin menghapus data dengan </span></h4>
                <h4><span>Id : <?= $u->id_cicit?> - Nama : <?=$u->nama_cicit?></span>?</h4>
      </div>
     
      <div class="modal-footer">
      <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
      <a href="<?= site_url('dashboard/hapus_cicit/' . $u->id_cicit) ?>" class="btn btn-danger" id="btdelete">Lanjutkan</a>
      </div>
