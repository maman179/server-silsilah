        ...
        <h3>SILSILAH KELUARGA MADNASIR DAN MBAH ERUM </h3>
            ...
            <li class="nav-item dropdown no-arrow">
                ...
                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                    ...
                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modalExit">
                            <i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400" a href="<?php echo base_url('login/logout'); ?>"></i>Logout
                        </a>
                </div>
            </li>
        </ul>
