							...
							<div class="row pt-2">
								<nav aria-label="breadcrumb">
									<ol class="breadcrumb">
										...
										<li class="breadcrumb-item active" aria-current="page">Detail Data Cicit</li>
									</ol>
									...
									<div class="container pt-2">
										<div class="row">
											<div class="col-12 text-right">
												<a href="<?= site_url('dashboard1/form_cicit/' . $u->id_cucu) ?>"
						...
						<tbody>
							...
							foreach ($cicit as $row) { ?>
								<tr>
									...
									<td><?php echo $row->nama_cicit ?></td>
									<td class="text"><?= $row->alamat_cicit ?></td>
									<td class="text-center"><?= $row->total_anak_cicit ?></td>
