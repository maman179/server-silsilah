<body>
	...
	<div class="col pt-2">
  	...
  	<div class="container pt-2">
		...
		<ol class="breadcrumb">
			<li class="breadcrumb-item"><a href="<?php echo base_url('dashboard1/dashboard1/tampil_data_anak'); ?>">Master Data</a></li>
			<li class="breadcrumb-item active" aria-current="page">Tambah Data Cucu</li>
		</ol>
        <div class="card-body"> -->
						...
						<div class="row pt-2">
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Detail Data Cucu </li>
								</ol>
								...
								<div class="container pt-2">
									<div class="row">
										<div class="col-12 text-right">
											<a href="<?= site_url('dashboard1/form_cucu/' . $u->id_anak) ?>"
					...
					<tbody>
						...
						foreach ($cucu as $row) { ?>
							<tr>
								...
								<td><?php echo $row->nama_cucu ?></td>
								<td class="text"><?= $row->alamat_cucu ?></td>
								<td class="text-center"><?= $row->total_anak_cucu ?></td>
