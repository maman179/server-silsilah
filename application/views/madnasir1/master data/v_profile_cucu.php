...
<div class="col pt-2">
	<nav aria-label="breadcrumb">
		<ol class="breadcrumb">
			<li class="breadcrumb-item"><a href="<?php echo base_url('dashboard1/tampil_data_orangtua'); ?>">Home</a></li>
			<li class="breadcrumb-item"><a href="#">Profile Anak</a></li>
		</ol>
			...
			<div class="row gutters-sm">
				<div class="col-md-4 mb-3">
						...
						<div class="card-body">
							<div class="d-flex flex-column align-items-center text-center">
								...
								<div class="mt-3">
									...
									<button type="button" class="btn btn-outline-success"><a href="<?= site_url('dashboard1/edit_cucu/' . $u->id_cucu) ?>">UBAH</a></button>
									<button type="button" class="btn btn-outline-danger tombol-hapus"><a href="<?= base_url('dashboard1/hapus_cucu/' . $u->id_cucu) ?>">Hapus</button></td>
									<button type="button" class="btn btn-outline-secondary"><a href="<?php echo base_url('dashboard1/tampil_data_cucu'); ?>">Kembali</a></button>
								</div>
							</div>
						</div>
					</div>
					...
					<?php if (!empty($u->latitude) && !empty($u->longitude)) : ?>
						...
						<!-- MAP -->
						<div class="map-wrapper-cucu">

							<div id="mapCucu<?= $u->id_cucu; ?>"
							...
							<div class="text-center mt-2">
								...
								<button type="button"
									...
									data-nama="<?= htmlspecialchars($u->nama_cucu, ENT_QUOTES, 'UTF-8'); ?>">
						...
						<div class="card-body">
							...
							<div class="row">
								...
								<div class="col-sm-7 text-secondary">
									...
									<a href="<?= site_url('dashboard1/tampil_chat_cucu/' . $u->id_cucu) ?>"><?= $u->NoHP_cucu; ?></a>
								</div>
							</div>
							<hr>
							...
							<div class="row">
								...
								<div class="col-sm-7 text-secondary">
									<a href="<?= site_url('dashboard1/detil_cicit/' . $u->id_cucu) ?>"><?= $u->total_anak_cucu; ?> ORANG</a>
								</div>
							</div>
							<hr>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<a href="<?= site_url('dashboard1/hapus_anak/' . $u->id_cucu) ?>" class="btn btn-danger" id="btdelete">Lanjutkan</a>
				</div>
			</div>
		</div>
	</div>
		...
		<?php foreach ($profile as $u) : ?>
			...
			<?php if (!empty($u->latitude) && !empty($u->longitude)) : ?>
				...
				marker.bindPopup(
					...
					'<b><?= htmlspecialchars($u->nama_cucu, ENT_QUOTES); ?></b><br>'
				).openPopup();
