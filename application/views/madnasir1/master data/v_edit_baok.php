...
<div class="col pt-2">
	<div class="card card-primary">
		<div class="card-header">
			<h3 class="card-title">FORM EDIT DATA BAOK</h3>
		</div>
		...
		<div class="card-body">
			...
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item">
						<a href="<?= base_url('dashboard1/tampil_data_baok'); ?>">
							Home
						</a>
					</li>
			...
			<?php foreach ($baok as $u) { ?>
				...
				<form
					action="<?= base_url('dashboard1/update_baok'); ?>"
					method="post"
					...
					<div class="form-group row text-center">
						<div class="col-md-12">
							<br>
							<img src="<?= base_url('assets/foto_baok/' . $u->foto_baok); ?>"
								width="130"
								height="130"
					...
					<div class="form-group row">
						...
						<div class="col-md-6">
							...
							<input
								...
								name="nama_baok"
								autocomplete="off"
								value="<?= htmlspecialchars($u->nama_baok); ?>"
						...
						<div class="col-md-6">
							<select
								...
								<option
									value="LAKI-LAKI"
									<?= ($u->jenis_kelamin_baok == 'LAKI-LAKI') ? 'selected' : ''; ?>>
									LAKI-LAKI
								</option>
								...
								<option
									value="PEREMPUAN"
									<?= ($u->jenis_kelamin_baok == 'PEREMPUAN') ? 'selected' : ''; ?>>
									PEREMPUAN
								</option>
					...
					<div class="form-group row">
						...
						<div class="col-md-6">
							...
							<input
								...
								name="tgl_lahir_baok"
								autocomplete="off"
								value="<?= date('Y-m-d', strtotime($u->tgl_lahir_baok)); ?>">
						...
						<div class="col-md-6">
							...
							<input
								...
								name="menantu_cicit"
								autocomplete="off"
								value="<?= htmlspecialchars(trim($u->menantu_baok)); ?>"
					...
					<div class="form-group row">
						<div class="col-md-8">
							...
							<input
								...
								id="alamat"
								name="alamat_baok"
								value="<?= htmlspecialchars($u->alamat_baok); ?>"
								autocomplete="off"
								readonly>
						...
						<div class="mt-3">
							...
							<div id="mapEditBaok" style="width:100%; height:400px; border:1px solid #ddd; border-radius:8px;">
							</div>
						...
						<div class="col-md-4">
							...
							<input
								...
								name="NoHP_baok"
								autocomplete="off"
								value="<?= htmlspecialchars($u->NoHP_baok); ?>"
					...
					<div class="form-group row">
						<div class="col-md-12">
							...
							<a
								href="<?= base_url('dashboard1/tampil_data_baok'); ?>"
...
<script src="<?= base_url('assets/js/edit_baok.js'); ?>"></script>