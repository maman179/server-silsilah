...
<!-- Page Heading -->
 ...
 <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">DATA ANAK Hj. OYOH [<?= $total_anak_oyoh ?> ANAK]</h3>
              </div>

<div class="container pt-2">
      <div class="row">
        <div class="col-9">
           <button type="button" class="btn btn-outline-info btn-sm"> <a href = "<?php echo base_url('cucu/print_anak_oyoh'); ?>"><i class="fa fa-print"></i>PRINT</a></button>
