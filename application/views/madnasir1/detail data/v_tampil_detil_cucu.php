...
<div class="col pt-2">
	...
	<nav aria-label="breadcrumb">
  	<ol class="breadcrumb">
		...
		<li class="breadcrumb-item active"><a href="<?php echo base_url('dashboard1/print_cucu'); ?>">Print</li></a>
...
<tbody>
		...
		<tr>
			...
			<td class="text-center"><a href="<?= site_url('dashboard1/view_profile_cucu/' . $u->id_cucu) ?>" class="btn btn-outline-info btn-sm"><i class="fa fa-eye"></i> View </a></td>			
