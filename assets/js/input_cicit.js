...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const form = document.getElementById("formTambahCicit");
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const mapElement = document.getElementById("mapInputCicit");
    ...
    const map = L.map("mapInputCicit").setView([lat, lng],15);
