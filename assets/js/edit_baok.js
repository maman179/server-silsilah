...
document.addEventListener("DOMContentLoaded", function () {
    const mapElement = document.getElementById("mapEditBaok");
    ...
    const map = L.map("mapEditBaok").setView([lat, lng], 17);
    ...
    // CEK SEBELUM SUBMIT
    const form = document.getElementById("formEditBaok");
