...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // ALAMAT LAMA
    const alamatLama = alamat.value.trim();
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const mapElement = document.getElementById("mapEditOrtu");
    ...
    const map = L.map("mapEditOrtu").setView(
        [lat, lng],
        17
    );
    ...
    const form = document.getElementById("formEditOrtu");
